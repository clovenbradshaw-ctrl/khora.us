...
const SEED_EVENTS = [
  // ── Event 1: Case Creation (Intake) ────────────────────────────────
  {
    ...
    ops: [
      ...
      // Identity & Contact
      { op: 'DES', field: 'preferred_name', claimId: 'pn1', value: 'Maria', agent: '@jreyes:khora.us', role: 'Intake Worker', mode: 'declared', note: 'Client introduced herself.' },
      { op: 'INS', field: 'preferred_name', claimId: 'pn1' },

      { op: 'DES', field: 'legal_name', claimId: 'ln1', value: 'Maria Elena Gonzalez', agent: '@jreyes:khora.us', role: 'Intake Worker', mode: 'declared', note: 'Per client.' },
      { op: 'INS', field: 'legal_name', claimId: 'ln1' },

      { op: 'DES', field: 'dob', claimId: 'dob1', value: '1988-03-14', agent: '@jreyes:khora.us', role: 'Intake Worker', mode: 'declared', note: 'Client self-reported.' },
      { op: 'INS', field: 'dob', claimId: 'dob1' },

      { op: 'DES', field: 'gender', claimId: 'g1', value: 'Female', agent: '@jreyes:khora.us', role: 'Intake Worker', mode: 'declared' },
      { op: 'INS', field: 'gender', claimId: 'g1' },

      { op: 'DES', field: 'pronouns', claimId: 'pr1', value: 'she/her', agent: '@jreyes:khora.us', role: 'Intake Worker', mode: 'declared' },
      { op: 'INS', field: 'pronouns', claimId: 'pr1' },

      { op: 'DES', field: 'language', claimId: 'lang1', value: 'Spanish', agent: '@jreyes:khora.us', role: 'Intake Worker', mode: 'observed', note: 'Interview conducted in Spanish.' },
      { op: 'INS', field: 'language', claimId: 'lang1' },

      { op: 'DES', field: 'interpreter_needed', claimId: 'int1', value: 'Yes', agent: '@jreyes:khora.us', role: 'Intake Worker', mode: 'observed', note: 'Client more comfortable in Spanish.' },
      { op: 'INS', field: 'interpreter_needed', claimId: 'int1' },

      { op: 'DES', field: 'phone', claimId: 'ph1', value: '(617) 555-0147', agent: '@jreyes:khora.us', role: 'Intake Worker', mode: 'declared' },
      { op: 'INS', field: 'phone', claimId: 'ph1' },

      { op: 'DES', field: 'phone_safety', claimId: 'ps1', value: 'Safe to text only', agent: '@jreyes:khora.us', role: 'Intake Worker', mode: 'declared', note: 'Client asked us to text, not call.' },
      { op: 'INS', field: 'phone_safety', claimId: 'ps1' },

      // Housing
      { op: 'DES', field: 'housing_status', claimId: 'h1', value: 'Emergency Shelter', agent: '@jreyes:khora.us', role: 'Intake Worker', mode: 'declared', note: 'Client staying at Pine St Inn.' },
      { op: 'INS', field: 'housing_status', claimId: 'h1' },

      { op: 'DES', field: 'housing_duration', claimId: 'hd1', value: '3 weeks', agent: '@jreyes:khora.us', role: 'Intake Worker', mode: 'declared' },
      { op: 'INS', field: 'housing_duration', claimId: 'hd1' },

      // Income
      { op: 'DES', field: 'monthly_income', claimId: 'mi1', value: '1200', agent: '@jreyes:khora.us', role: 'Intake Worker', mode: 'declared', note: 'Client reported part-time work income.' },
      { op: 'INS', field: 'monthly_income', claimId: 'mi1' },

      { op: 'DES', field: 'employment_status', claimId: 'es1', value: 'Employed Part-Time', agent: '@jreyes:khora.us', role: 'Intake Worker', mode: 'declared' },
      { op: 'INS', field: 'employment_status', claimId: 'es1' },

      // Safety
      { op: 'DES', field: 'safety_assessment', claimId: 'sa1', value: 'Minor concerns', agent: '@jreyes:khora.us', role: 'Intake Worker', mode: 'observed', note: 'Client appeared anxious but no immediate safety concern.' },
      { op: 'INS', field: 'safety_assessment', claimId: 'sa1' },

      { op: 'DES', field: 'children_in_home', claimId: 'ch1', value: '2', agent: '@jreyes:khora.us', role: 'Intake Worker', mode: 'declared', note: 'Ages 4 and 7.' },
      { op: 'INS', field: 'children_in_home', claimId: 'ch1' },

      // Services
      { op: 'DES', field: 'case_status', claimId: 'cs1', value: 'Intake', agent: '@jreyes:khora.us', role: 'Intake Worker', mode: 'measured' },
      { op: 'INS', field: 'case_status', claimId: 'cs1' },

      // Household
      { op: 'DES', field: 'household_size', claimId: 'hs1', value: '3', agent: '@jreyes:khora.us', role: 'Intake Worker', mode: 'declared', note: 'Client plus two children.' },
      { op: 'INS', field: 'household_size', claimId: 'hs1' },

      { op: 'DES', field: 'dependents', claimId: 'dep1', value: '2', agent: '@jreyes:khora.us', role: 'Intake Worker', mode: 'declared' },
  ...
  // ── Event 2: Benefits check (same day) ─────────────────────────────
  {
    ...
    agentRole: 'Intake Worker',
    ops: [
      { op: 'DES', field: 'insurance', claimId: 'ins1', value: 'None', agent: '@jreyes:khora.us', role: 'Intake Worker', mode: 'declared', note: 'Client reports no current insurance.' },
      { op: 'INS', field: 'insurance', claimId: 'ins1' },

      { op: 'DES', field: 'benefits_receiving', claimId: 'br1', value: 'SNAP', agent: '@jreyes:khora.us', role: 'Intake Worker', mode: 'declared', note: 'Receiving SNAP benefits.' },
      { op: 'INS', field: 'benefits_receiving', claimId: 'br1' },

      { op: 'DES', field: 'benefits_applied', claimId: 'ba1', value: 'SSI, Medicaid', agent: '@jreyes:khora.us', role: 'Intake Worker', mode: 'declared', note: 'Applied for SSI and Medicaid last month.' },
      { op: 'INS', field: 'benefits_applied', claimId: 'ba1' },

      { op: 'DES', field: 'housing_referral', claimId: 'hr1', value: 'HomeStart RRH Program', agent: '@jreyes:khora.us', role: 'Intake Worker', mode: 'measured', note: 'Referral submitted.' },
  ...
  // ── Event 3: Case activation by assigned caseworker ────────────────
  {
    ...
    ops: [
      ...
      { op: 'DES', field: 'email', claimId: 'em1', value: 'maria.g.88@gmail.com', agent: '@tkhan:khora.us', role: 'Caseworker', mode: 'declared', note: 'Client provided email at first meeting.' },
      { op: 'INS', field: 'email', claimId: 'em1' },

      { op: 'DES', field: 'client_goals', claimId: 'cg1', value: 'Find stable housing for family. Get kids enrolled in school near new apartment.', agent: '@tkhan:khora.us', role: 'Caseworker', mode: 'declared', note: 'From goal-setting conversation.' },
      { op: 'INS', field: 'client_goals', claimId: 'cg1' },

      { op: 'DES', field: 'next_contact_date', claimId: 'ncd1', value: '2025-06-25', agent: '@tkhan:khora.us', role: 'Caseworker', mode: 'measured' },
      { op: 'INS', field: 'next_contact_date', claimId: 'ncd1' },

      { op: 'DES', field: 'agreed_next_steps', claimId: 'ans1', value: 'Gather documents for housing application. Schedule Medicaid follow-up.', agent: '@tkhan:khora.us', role: 'Caseworker', mode: 'declared' },
  ...
  // ── Event 4: ID document verification ──────────────────────────────
  {
    ...
    agentRole: 'Caseworker',
    ops: [
      { op: 'DES', field: 'id_documents', claimId: 'id1', value: 'State ID (MA) — verified. Birth certificates for both children — verified.', agent: '@tkhan:khora.us', role: 'Caseworker', mode: 'measured', note: 'Reviewed originals in office.' },
  ...
  // ── Event 5: Housing update — income discrepancy (SUP/contested) ───
  {
    ...
    ops: [
      ...
      // Housing update
      { op: 'DES', field: 'housing_history', claimId: 'hh1', value: 'Lived with partner until May 2025. Left due to safety concerns. Shelter since early June.', agent: '@tkhan:khora.us', role: 'Caseworker', mode: 'declared', note: 'Client disclosed housing history.' },
      { op: 'INS', field: 'housing_history', claimId: 'hh1' },

      { op: 'DES', field: 'eviction_risk', claimId: 'er1', value: 'None', agent: '@tkhan:khora.us', role: 'Caseworker', mode: 'observed', note: 'Currently in shelter — no eviction risk applies.' },
  ...
  // ── Event 6: Safety screening by supervisor ────────────────────────
  {
    ...
    ops: [
      // DV/IPV screening
      { op: 'DES', field: 'dv_ipv_screening', claimId: 'dv1', value: 'Past DV/IPV', agent: '@mchen:khora.us', role: 'Supervisor', mode: 'observed', note: 'Based on housing history and interview with client.' },
      { op: 'INS', field: 'dv_ipv_screening', claimId: 'dv1' },

      { op: 'DES', field: 'safety_plan', claimId: 'sp1', value: 'Yes', agent: '@mchen:khora.us', role: 'Supervisor', mode: 'measured', note: 'Safety plan created and filed.' },
      ...
      { op: 'DES', field: 'mh_referral', claimId: 'mhr1', value: 'Referred to BMC trauma counseling', agent: '@mchen:khora.us', role: 'Supervisor', mode: 'measured', note: 'Referral submitted.' },
  ...
  // ── Event 7: Medicaid confirmed ────────────────────────────────────
  {
    ...
    ops: [
      ...
      { op: 'DES', field: 'primary_care', claimId: 'pc1', value: 'Yes', agent: '@tkhan:khora.us', role: 'Caseworker', mode: 'measured', note: 'Assigned to BMC primary care.' },
      { op: 'INS', field: 'primary_care', claimId: 'pc1' },

      { op: 'DES', field: 'health_provider', claimId: 'hp1', value: 'Boston Medical Center', agent: '@tkhan:khora.us', role: 'Caseworker', mode: 'measured' },
  ...
  // ── Event 8: Housing stabilization progress ────────────────────────
  {
    ...
    agentRole: 'Caseworker',
    ops: [
      { op: 'DES', field: 'housing_goal', claimId: 'hg1', value: '2-bedroom apartment in Dorchester/Roxbury area', agent: '@tkhan:khora.us', role: 'Caseworker', mode: 'declared', note: 'Client wants to stay near her support network.' },
      { op: 'INS', field: 'housing_goal', claimId: 'hg1' },

      { op: 'DES', field: 'housing_barriers', claimId: 'hb1', value: 'Limited credit history. No recent rental references. Income may be below requirement for some units.', agent: '@tkhan:khora.us', role: 'Caseworker', mode: 'observed' },
      { op: 'INS', field: 'housing_barriers', claimId: 'hb1' },

      { op: 'DES', field: 'programs_enrolled', claimId: 'pe1', value: 'HomeStart RRH, SNAP, MassHealth', agent: '@tkhan:khora.us', role: 'Caseworker', mode: 'measured' },
      { op: 'INS', field: 'programs_enrolled', claimId: 'pe1' },

      { op: 'DES', field: 'worker_assessment', claimId: 'wa1', value: 'Client is engaged and motivated. Children are stable in school. Main barrier is affordable housing availability. Income situation needs clarification.', agent: '@tkhan:khora.us', role: 'Caseworker', mode: 'observed' },
      ...
      { op: 'DES', field: 'case_notes', claimId: 'cn1', value: 'Submitted RRH application to HomeStart. Landlord outreach pending. Client meeting with housing search specialist next week.', agent: '@tkhan:khora.us', role: 'Caseworker', mode: 'observed' },
  ...
  // ── Event 9: Income resolution (SYN) ───────────────────────────────
  {
    ...
    ops: [
      ...
      { op: 'DES', field: 'employer', claimId: 'emp1', value: 'Sunrise Cleaning Services', agent: '@tkhan:khora.us', role: 'Caseworker', mode: 'measured', note: 'From employer verification letter.' },
      { op: 'INS', field: 'employer', claimId: 'emp1' },

      { op: 'DES', field: 'income_sources', claimId: 'is1', value: 'Part-time employment (Sunrise Cleaning Services, ~25-35 hrs/week). SNAP benefits.', agent: '@tkhan:khora.us', role: 'Caseworker', mode: 'measured' },
  ...
  // ── Event 10: Emergency contact & support ──────────────────────────
  {
    ...
    agentRole: 'Caseworker',
    ops: [
      { op: 'DES', field: 'emergency_contact', claimId: 'ec1', value: 'Rosa Gonzalez (sister) — (617) 555-0283', agent: '@tkhan:khora.us', role: 'Caseworker', mode: 'declared' },
      { op: 'INS', field: 'emergency_contact', claimId: 'ec1' },

      { op: 'DES', field: 'informal_support', claimId: 'isup1', value: 'Sister Rosa nearby in Dorchester. Church community at St. Peter\'s. Children\'s school staff are supportive.', agent: '@tkhan:khora.us', role: 'Caseworker', mode: 'declared', note: 'Client described her support system.' },
      { op: 'INS', field: 'informal_support', claimId: 'isup1' },

      { op: 'DES', field: 'household_members', claimId: 'hm1', value: 'Maria (37, head of household). Sofia (7, daughter). Diego (4, son).', agent: '@tkhan:khora.us', role: 'Caseworker', mode: 'declared' },
      { op: 'INS', field: 'household_members', claimId: 'hm1' },

      { op: 'DES', field: 'veteran_status', claimId: 'vs1', value: 'No', agent: '@tkhan:khora.us', role: 'Caseworker', mode: 'declared' },
  ...
  // ── Event 11: Housing placement ────────────────────────────────────
  {
    ...
    ops: [
      ...
      { op: 'DES', field: 'program_classification', claimId: 'pcl1', value: 'RRH', agent: '@tkhan:khora.us', role: 'Caseworker', mode: 'measured' },
